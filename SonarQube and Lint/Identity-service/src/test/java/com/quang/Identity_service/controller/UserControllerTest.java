...
public class UserControllerTest {
    ...
    void createUser_validRequest_success() throws Exception {
        ...
        Mockito.when(userSevice.createUser(ArgumentMatchers.any())).thenReturn(userReponse);
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/users")
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("result.id").value("07b4fc9dde25"));
    ...
    void createUser_userInvalid_success() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/users")
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("message").value("user name must be at least 4 character"));
